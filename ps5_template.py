...
#       Check for yourself: arch_model.params[0] should be 0.0018  (rounded to 4 digits)
if status == 'SOLN':
...
#
# HINT: Check for yourself: test_garch_variance[0] should be 0.1705 (rounded to 4 digits)
